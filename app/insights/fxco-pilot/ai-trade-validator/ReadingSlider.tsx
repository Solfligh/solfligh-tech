    ...
    () => [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "If you buy signals, you already know the feeling: you see the alert, your heart speeds up, and you’re halfway into the trade before you’ve even checked if the market still agrees.",
          "FXCO-Pilot is the pause button. Drop in the pair, direction, timeframe, and your intended risk—and it tells you whether the entry is late, whether structure still supports it, and whether the risk-to-reward still makes sense at this exact price.",
          "Sometimes it confirms the signal and you execute with confidence. Other times it saves you from paying for a screenshot—because the context already shifted. That one checkpoint is the difference between following signals and being controlled by them.",
